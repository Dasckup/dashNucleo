...
<head>
    ...
    <body>
        <div class="app horizontal-menu app-auth-lock-screen align-content-stretch d-flex flex-wrap justify-content-end">
            ...
            <div class="app-auth-container position-relative">
                ...
                <p class="auth-description">Este é dashboard feito para editores da revista avaliarem artigos</p>
                <form method="POST" action="{{route("AppEditor.login.store")}}">
                @csrf

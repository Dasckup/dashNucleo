...
<div class="material card card-body m-0 mb-2 p-3">
    <div class="d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center">
            ...
            <a href="{{route('AppEditor.material.show', ['id' => $process->proccess_id])}}" class="text-primary ms-2">
        ...
        <div>
            <div class="d-flex align-items-center">
                <div style="width:50px;height:50px;border-radius:100%" class="badge-bg-success badge badge-style-light rounded-pill badge-primary ms-2 d-flex align-items-center justify-content-center">
                    Par 1
                </div>
                <div style="width:50px;height:50px;border-radius:100%" class="badge-bg-danger badge badge-style-light rounded-pill badge-primary ms-2 d-flex align-items-center justify-content-center">
                    Par 2
                </div>
            </div>
        </div>
